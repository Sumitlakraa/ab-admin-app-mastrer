...
@Component({
  selector: 'app-upload-commuter-pricing-dialog',
  templateUrl: './upload-commuter-pricing-dialog.component.html',
  styleUrls: ['./upload-commuter-pricing-dialog.component.scss']
})
export class UploadCommuterPricingDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<UploadCommuterPricingDialogComponent>, private fileUploadService: FileUploadService, 
...
//      NetworkUtil.showSnackBar( this.snackBar, 'Please complete form');
  ...
  uploadFile(file: File) {
    if(file != null) {
      ...
      this.fileUploadService.uploadCommuterPricing(file, token)
      .pipe(
